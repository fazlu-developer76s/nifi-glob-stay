            ...
            <div class="d-flex align-items-center mb-3">
                <div>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><i class="fa fa-arrow-back"></i> Create  Category</li>
                    </ol>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault{{ $category->id }}" {{ ($category->status == 1) ? 'checked' : '' }} onchange="ChangeStatus('categories',{{ $category->id }});" >
                                            </div>
                                        </td>
                                        <td>
